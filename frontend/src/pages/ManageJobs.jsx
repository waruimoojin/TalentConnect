...
const ManageJobs = () => {
    const {
        ...
        queryFn: () =>
            getAllHandler(
                `https://talent-connect-backend.vercel.app/api/v1/jobs/my-jobs`
            ),
    });
    ...
    const deleteJobHandler = async (id) => {
        try {
            const response = await axios.delete(
                `https://talent-connect-backend.vercel.app/api/v1/jobs/${id}`,
            ...
            // setJobs(updateJobs);
            // handleJobFetch(
            //     `https://talent-connect-backend.vercel.app/api/v1/jobs?page=1`
            // );
            refetch();
            Swal.fire({
                title: "Deleted!",
